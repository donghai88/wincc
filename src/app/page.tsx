    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--void)' }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div
          style={{
            flex: 1,
            overflow: isImmersiveTwin ? 'hidden' : 'auto',
            padding: isImmersiveTwin ? 0 : 20,
          }}
        >
          {renderContent()}
        </div>
